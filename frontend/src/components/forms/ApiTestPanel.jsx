...
function ArrayPathCard({ path, count, sampleKeys = [], isActive, onSelect }) {
    ...
    return (
        <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl border transition-all duration-150 ${isActive
        ...
        >
            <div className="flex items-center justify-between mb-1">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${isActive ? 'bg-brand-600/30 text-brand-300' : 'bg-[#1e2535] text-[#8892a4]'
                    }`}>
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-[#0f1117] rounded-xl border border-[#1e2535]">
                <span className={`text-xs font-bold font-mono px-2 py-1 rounded ${form.method === 'GET' ? 'bg-emerald-500/20 text-emerald-400' :
                                ...
                                <div className="flex gap-1 p-3 border-b border-[#1e2535]">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${viewMode === m.id
