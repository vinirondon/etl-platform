...
export default function IntegrationForm({ integration, companies, onSave, onClose }) {
    ...
    useEffect(() => {
        if (integration) {
            ...
            // Converte delete_before_insert para boolean
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={f('dedup_field')}
                            placeholder="id"
                            disabled={form.delete_before_insert}
                        />
                        <p className="text-xs text-[#8892a4] mt-1">
                            Campo único para evitar inserir duplicatas. Registros existentes serão atualizados.
                    ...
                    <div className="pt-2 border-t border-[#1e2535]">
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-2">
                            ...
                            <button
                                type="button"
                                onClick={() => setForm(p => ({ ...p, delete_before_insert: false }))}
                                className={`p-3 rounded-lg border text-left transition-all ${!form.delete_before_insert
                                        ? 'border-brand-500 bg-brand-600/10 text-white'
                                        : 'border-[#1e2535] bg-[#0f1117] text-[#8892a4] hover:border-[#2d3748]'
                                    }`}
                            >
                                ...
                                <p className="text-xs text-[#8892a4] leading-relaxed pl-5">
                                    Atualiza registros existentes e insere novos. Requer campo de deduplicação.
                                </p>
                            </button>

                            {/* Opção: Deletar e Reinserir */}
                            <button
                                type="button"
                                onClick={() => setForm(p => ({ ...p, delete_before_insert: true, dedup_field: '' }))}
                                className={`p-3 rounded-lg border text-left transition-all ${form.delete_before_insert
                            ...
                            >
                                ...
                                <p className="text-xs text-[#8892a4] leading-relaxed pl-5">
                                    Remove todos os dados da empresa na tabela e insere tudo novamente a cada execução.
                                </p>
                            </button>

                        </div>

                        {/* Aviso quando Deletar e Reinserir está ativo */}
                        {form.delete_before_insert && (
                            <div className="mt-3 p-3 bg-red-500/10 border border-red-500/20 rounded-lg flex gap-2">
                                ...
                                <p className="text-xs text-red-300 leading-relaxed">
                                    ...
                                    Outros dados na mesma tabela de outras empresas <strong>não serão afetados</strong>.
                                </p>
                            </div>
                        )}
                    </div>
